                        ...
                        <form method="POST" action="{{ route('login') }}" class="grid gap-6">
                            ...
                            <label class="block">
                                <input
                                    ...
                                    focus:outline-none focus:border-[#0D63F3]" placeholder="Password" 
                                    s/>
                            </label>
                            ...
                            <div class="mt-10 grid gap-6">
                                <button class="text-center text-white text-lg font-medium 
                                bg-[#0D63F3] px-10 py-4 rounded-full">
                                Sign In
                                </button>
                                <a
                                href="{{ route('register') }}"class="text-center text-lg text-[#1E2B4F] font-medium 
                                bg-[#F2F6FE] px-10 py-4 rounded-full">
                                New Account
                                </a>
                            </div>
                        </form>
                        ...
                        <div class="flex items-center">
                            <div class="ring-1 ring-[#0D63F3] ring-offset-4 rounded-full">
                                <img
                                    ...
                                    src="{{ ('/assets/frontsite/images/patient-testimonial.png') }}"
                                    alt=""/>
                            </div>
                            <div class="ml-5">
