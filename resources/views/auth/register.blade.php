                        ...
                        <form method="POST" action="{{ route('register') }}" class="grid gap-6">
                            ...
                            <label class="block">
                                <input
                                    ...
                                    placeholder:text-[#AFAEC3] placeholder:font-normal px-7 border border-[#d4d4d4] focus:outline-none 
                                    focus:border-[#0D63F3]"placeholder="Password" value="{{ old('password') }}" required autofocus/>
                            </label>
                            ...
                            <label class="block">
                                <input
                                    ...
                                    focus:outline-none focus:border-[#0D63F3]"placeholder="Confirmation Password" required autofocus/>
                            ...
                            <div class="mt-10 grid gap-6">
                                <button type="submit" class="text-center text-white text-lg font-medium 
                                    bg-[#0D63F3] px-10 py-4 rounded-full">
                                    Continue
                                </button>

                                <a href="{{ route('login') }}" class="text-center text-lg text-[#1E2B4F] 
                                    font-medium bg-[#F2F6FE] px-10 py-4 rounded-full">
                                    Sign In
                                </a>
                            </div>
                        </form>
