...
<div class="max-w-7xl mx-auto px-4 lg:px-14 pt-6 lg:py-10">
    <div class="flex justify-between h-16">
        <div class="flex flex-auto justify-between">
            ...
            <a href="{{ route('index') }}"
                class="text-[#1E2B4F] relative {{ request()->is('/') ? "after:absolute 
                after:content-[''] after:border-b-2 after:border-[#0D63F5] after:w-8/12
                after:-translate-x-1/2 after:bottom-3 after:left-1/2 font-semibold
                inline-flex items-center px-1 text-lg" : "hover:text-gray-500 inline-flex 
                ...
                <div x-data="{ profileDekstopOpen: false }" class="ml-3 relative">
                    <div>
                        ...
                        <div class="text-right mr-5">
                            ...
                            {{-- This section must read from section type user --}}
