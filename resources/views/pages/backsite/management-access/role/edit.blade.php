                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            ...
                                                            placeholder="example admin or users" value="{{ old('title', isset($role) ? $role->title : '') }}" autocomplete="off" required>
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            ...
                                                            <select name="permission[]"
                                                                ...
                                                                @foreach($permission as $id => $permission_item)
                                                                    <option value="{{ $permission_item->id }}" {{ (in_array($permission_item->id, old('permission', 
                                                                    [])) || isset($role) && $role->permission->contains($permission_item->id)) ? 'selected' : '' }}>
